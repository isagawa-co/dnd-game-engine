...
## Deliverables
- `.claude/skills/combat/contracts/combat-loop-contract.json` — main combat loop contract
- `.claude/skills/combat/contracts/combat-state-contract.json` — combatant state contract
- `.claude/skills/combat/contracts/combat-action-contract.json` — action resolution contract
- `.claude/skills/combat/SKILL.md` — combat skill definition
