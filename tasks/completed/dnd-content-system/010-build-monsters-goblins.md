...
## Requirements
- Create `content/lost-mine-phandelver/monsters/goblin.json` — CR 1/4, AC 15, HP 7 (2d6), Small
- Create `content/lost-mine-phandelver/monsters/hobgoblin.json` — CR 1/2, AC 18, HP 11 (2d8+2), Medium
- Create `content/lost-mine-phandelver/monsters/bugbear.json` — CR 1, AC 16, HP 27 (5d8+5), Medium
- Schema example in `backlog/002-dnd-build-content-system/pack-structure.md`
