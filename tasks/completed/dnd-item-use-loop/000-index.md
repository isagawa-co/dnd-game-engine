...
## Source
→ [[backlog/016-dnd-build-item-use-loop.md]]
→ [[backlog/016-dnd-build-item-use-loop/item-effect-contract.md]]
...
## Deliverables
- `.claude/skills/item-use/SKILL.md` — skill definition
- `.claude/skills/item-use/contracts/item-use-loop-contract.json` — input/output contract
- `.claude/skills/item-use/contracts/item-effect-catalog.json` — effect catalog
- `.claude/skills/item-use/contracts/attunement-rules.json` — attunement rules
- `.claude/skills/item-use/contracts/validation-rules.json` — validation rules
