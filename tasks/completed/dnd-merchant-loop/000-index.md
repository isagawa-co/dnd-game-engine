...
## Deliverables
- `.claude/skills/merchant/contracts/merchant-loop-contract.json` — transaction contract
- `.claude/skills/merchant/contracts/shop-inventory-contract.json` — shop inventory contract
- `.claude/skills/merchant/contracts/negotiation-contract.json` — negotiation contract
- `.claude/skills/merchant/SKILL.md` — merchant skill definition
