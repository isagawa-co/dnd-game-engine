...
## Deliverables
- `.claude/skills/game-session/contracts/` — 4 JSON contracts
- `.claude/skills/game-session/SKILL.md` — game-session skill definition
- `.claude/skills/game-session/` — Python modules
- `tests/test_game_session.py` — comprehensive tests
