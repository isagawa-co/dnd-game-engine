...
## Requirements
- Create `projects/ai-dnd-game/.claude/skills/content/contracts/item-schema.json`
- Full schema in `projects/ai-dnd-game/backlog/002-dnd-build-content-system/content-contracts.md` Contract 3
