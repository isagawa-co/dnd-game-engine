...
## Requirements
- Create `projects/ai-dnd-game/.claude/skills/content/contracts/monster-schema.json`
- Full schema definition in `projects/ai-dnd-game/backlog/002-dnd-build-content-system/content-contracts.md` Contract 1
