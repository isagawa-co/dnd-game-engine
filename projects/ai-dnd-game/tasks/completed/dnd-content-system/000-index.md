...
## Deliverables
- `projects/ai-dnd-game/.claude/skills/content/contracts/` — 6 JSON schemas
- `projects/ai-dnd-game/.claude/skills/content/catalog.json` — Tier 1 master index
- `projects/ai-dnd-game/.claude/skills/content/SKILL.md` — content skill definition
- `projects/ai-dnd-game/content/lost-mine-phandelver/` — complete pack (manifest + 45 content files)
