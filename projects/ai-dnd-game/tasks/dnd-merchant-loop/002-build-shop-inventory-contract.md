...
## Requirements
- Create `projects/ai-dnd-game/.claude/skills/merchant/contracts/shop-inventory-contract.json`
...
## Acceptance Criteria
- [ ] `projects/ai-dnd-game/.claude/skills/merchant/contracts/shop-inventory-contract.json` exists
