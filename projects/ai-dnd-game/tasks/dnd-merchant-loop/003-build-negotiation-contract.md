...
## Requirements
- Create `projects/ai-dnd-game/.claude/skills/merchant/contracts/negotiation-contract.json`
...
## Acceptance Criteria
- [ ] `projects/ai-dnd-game/.claude/skills/merchant/contracts/negotiation-contract.json` exists
