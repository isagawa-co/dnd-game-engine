...
## Requirements
- Create `projects/ai-dnd-game/.claude/skills/item-use/contracts/validation-rules.json`
...
## Acceptance Criteria
- [ ] `projects/ai-dnd-game/.claude/skills/item-use/contracts/validation-rules.json` exists
- [ ] File is valid JSON
