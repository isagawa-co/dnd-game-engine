...
## Requirements
- Create `projects/ai-dnd-game/.claude/skills/item-use/contracts/item-use-loop-contract.json`
...
## Acceptance Criteria
- [ ] `projects/ai-dnd-game/.claude/skills/item-use/contracts/item-use-loop-contract.json` exists
